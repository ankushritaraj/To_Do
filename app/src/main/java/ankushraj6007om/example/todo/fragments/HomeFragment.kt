...
import ankushraj6007om.example.todo.databinding.FragmentHomeBinding
import ankushraj6007om.example.todo.utils.ToDoAdapter
...
class HomeFragment : Fragment(),AddTodoFragment.DialogNextBtnClickListener,
    ...
    override fun onSaveTask(todo: String, todoEt: TextInputEditText){
        databaseRef.push().setValue(todo).addOnCompleteListener{
            if(it.isSuccessful){
                Toast.makeText(context,"Todo saves successfully",Toast.LENGTH_SHORT).show()
                todoEt.text=null
